...
Make `/setup-hoangta-skills` friendlier and align the local-markdown tracker with the current spec.
...
Docs pages for `setup-hoangta-skills` and `to-tickets` re-synced.
