# Verify/Check Mode for `setup-hoangta-skills`

This project will not add a dedicated verify/check mode (or a separate verify skill) for `setup-hoangta-skills`.
...
- #106 — Feature request: verify/check mode for setup-hoangta-skills
