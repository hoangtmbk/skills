...
- **[grill-the-experts](./grill-the-experts/SKILL.md)** — A grilling where expert subagents answer the detail questions: a panel is routed per question, adjudicated evidence-weighted against your rubric, and logged with receipts; only preference calls come back to you. User-invoked.
