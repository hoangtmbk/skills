...
- **Hard dependency** (`to-issues`, `to-prd`, `triage`) — include an explicit one-liner: _"… should have been provided to you — run `/setup-hoangta-skills` if not."_ Without the mapping, output is wrong, not just fuzzy.
